...
'Filename is required to create a datastore!')
    ...
    // Method to save tutor availability user information within JSON file
    async createPostTutor(attrs) {
        const records = await this.getAllRecords()
        const { Name, Email, Subject , Contact } = attrs
...
module.exports = new Repository('datastore4.json')